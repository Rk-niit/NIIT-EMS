    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="Equipmentorders.php">Order Details</a></li>
            ...
            <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-bottom: 100%; background-color: white">
                        <div class="card">
                            <div class="card-body">
...
<?php
  ...
  $db = mysqli_connect("localhost", "root", "", "ems1");
  ...
  $result = mysqli_query($db, "SELECT image, image_text FROM images where id='1'");
?>
  ...
  ?>
  <form method="POST" action="Checklist_panel.php" enctype="multipart/form-data">
  ...
  <a href="/ems/view/dataoperator/images/adduser.PNG" download>
  <button>Download
  </button></a>
</div>
</body>
