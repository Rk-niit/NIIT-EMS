                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="Equipments.php">Equipments</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "select * from equipment_master where Equipment_name like '%$name%'  ";
...
<tr>
     ...
     <td><?php echo "".$row['Equipment_name']; ?> </td>
      <td><?php echo "".$row['Equipment_type_id']; ?> </td>
        ...
        <td> 
        <form>
<input type="button" value="Delete"  onclick="myFunction(); window.location.href='del.php?id=<?php echo $row['id'] ?>'"/>
