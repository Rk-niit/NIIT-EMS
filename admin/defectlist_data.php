             ...
             <div class="page-breadcrumb">
                <div class="row" >
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Defect list</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item"><a href="defectlist_data.php">Defect list</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="row"  style="margin-bottom: 100%">
 ...
 <ul class="breadcrumb">
  <?php
include('../models/defectlistcsv.php');
$csv = new csv();
if(isset($_POST['sub']))
{
...
<form method="post">
    <h4>Export in CSV</h4>
    <a href="/ems/view/admin/files/Importdefectlist.csv" download>
...
<h1>Search Defectlist</h1>
<form method="post" action="Users.php">
  <input type="text" name="fname"style="margin-right: 10px">
  <input type="button" value="Search" name="search" style="margin-right: 10px">
...
// Check connection
  ...
  $query = "SELECT * FROM `defectlist_master` ";
