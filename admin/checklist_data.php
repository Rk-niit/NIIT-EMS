                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="checklist_data.php">Checklist</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<form method="post">
    <h4>Export in CSV</h4>
    <a href="/ems/view/admin/files/Importchecklist.csv" download>
...
// Check connection
  ...
  # code...
  $query = "SELECT * FROM `checklist_master` ";
