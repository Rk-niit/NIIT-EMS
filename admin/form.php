                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="form.php">Report</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<table>
    ...
    <div class="input-group">
      ...
      From</td><td><input type="date" id="date1" name="date1"><br> 
    </div></td></tr><tr></br></br></br></br>
    <div class="input-group">
     
     <td> To</td><td><input type="date" id="date2" name="date2"><br>
    </div>
    </td></tr></br></br>
...
<div class="col-sm-2">
                  <select select name="Category[]" required>
    ...
    <option value="5">Defectlist</option>
    </select></div></div></br></br></td></tr> </table>            <table><tr><td>
<div class="input-group">
      <button style="color: red" type="submit" class="btn" name="reg_user">Report</button>
</form></td>            
</tr></table></div>                  
