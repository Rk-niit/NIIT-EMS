                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="addequip.php">Add Equipments</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<form method="post">
    <h4>Export in CSV</h4>
    <a href="/ems/view/admin/files/ImportEquipments.csv" download>
    <input type="button" name="Export Sample" value="Sample Download"></a>
...
<body>
  <div class="header" style="margin-left: 300px; width: 90%">
...
<form method="post" action="equipments.php">
  ...
  <form method="post" action="../models/addequip.php">
  ...
  <select select name="Freq[]" required>
    <option value="None">Maintenance frequency</option>
    <option value="Yearly">Yearly</option>
    <option value="Half yearly">Half yearly</option>
    <option value="Quaterly">Quaterly</option>
    <option value="Two monthly">Two monthly</option>
...
$query= "SELECT Location_name FROM location_master ";
...
<div class="styled-select black rounded">
<div class="col-sm-2">
                  <select id="role1" name="Loc[]" class="form-control">
...
$query= "SELECT Equipment_type FROM equipment_type ";
...
<div class="styled-select black rounded">
<div class="col-sm-2">
                  <select id="role1" name="Type[]" class="form-control">
...
<select select name="Status[]" required>
    ...
    <div class="input-group">
      <button type="submit" class="btn" name="reg_equip">Add Equipments</button.>
